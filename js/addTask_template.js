...
function printTasksInBoard(task, index, subTasksLength) {
    return /*html*/ `
        <div id="todobox${index}" onclick="showDetailBox(${index})" class="todoBox cp" draggable="true" ondragstart="startDragging(${index})">
            <div class="categoryAndMenu">
                <div class="todoCategory" id="todoCategory${index}">${task.category}</div>
                <svg width="6" height="22" viewBox="0 0 6 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3.21842 21.6666C2.48509 21.6666 1.85731 21.4055 1.33509 20.8833C0.812869 20.361 0.551758 19.7333 0.551758 18.9999C0.551758 18.2666 0.812869 17.6388 1.33509 17.1166C1.85731 16.5944 2.48509 16.3333 3.21842 16.3333C3.95176 16.3333 4.57954 16.5944 5.10176 17.1166C5.62398 17.6388 5.88509 18.2666 5.88509 18.9999C5.88509 19.7333 5.62398 20.361 5.10176 20.8833C4.57954 21.4055 3.95176 21.6666 3.21842 21.6666ZM3.21842 13.6666C2.48509 13.6666 1.85731 13.4055 1.33509 12.8833C0.812869 12.361 0.551758 11.7333 0.551758 10.9999C0.551758 10.2666 0.812869 9.63881 1.33509 9.11659C1.85731 8.59436 2.48509 8.33325 3.21842 8.33325C3.95176 8.33325 4.57954 8.59436 5.10176 9.11659C5.62398 9.63881 5.88509 10.2666 5.88509 10.9999C5.88509 11.7333 5.62398 12.361 5.10176 12.8833C4.57954 13.4055 3.95176 13.6666 3.21842 13.6666ZM3.21842 5.66659C2.48509 5.66659 1.85731 5.40547 1.33509 4.88325C0.812869 4.36103 0.551758 3.73325 0.551758 2.99992C0.551758 2.26659 0.812869 1.63881 1.33509 1.11659C1.85731 0.594363 2.48509 0.333252 3.21842 0.333252C3.95176 0.333252 4.57954 0.594363 5.10176 1.11659C5.62398 1.63881 5.88509 2.26659 5.88509 2.99992C5.88509 3.73325 5.62398 4.36103 5.10176 4.88325C4.57954 5.40547 3.95176 5.66659 3.21842 5.66659Z" fill="black"/>
                </svg>
            </div>
